...
public class SkinFragment extends TuEditSkinFragment{
    ...
    protected void loadView(ViewGroup var1) {
        ...
        getViewById(R.id.lsq_cancelButton).setOnClickListener(new TuSdkViewHelper.OnSafeClickListener() {
            @Override
            public void onSafeClick(View view) {
                handleBackButton();
            }
        });
        getViewById(R.id.lsq_completeButton).setOnClickListener(new TuSdkViewHelper.OnSafeClickListener() {
            @Override
            public void onSafeClick(View view) {
