...
import org.lasque.tusdkdemo.examples.api.DefineCameraBaseFragment;
 ...
 * @author Clear
 */
public class CameraComponent extends SampleBase implements TuCameraFragmentDelegate
{
	/** 相机组件范例 */
	...
	public void showSample(Activity activity)
	{
		...
		// 控制器类型
		 option.setComponentClazz(DefineCameraBaseFragment.class);
...
//        option.setRootViewLayoutId(R.layout.demo);
        ...
        DefineCameraBaseFragment fragment = (DefineCameraBaseFragment) option.fragment();
