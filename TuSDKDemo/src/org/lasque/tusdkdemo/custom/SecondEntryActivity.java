 ...
 * 第二个页面
 */
public class SecondEntryActivity extends TuFragmentActivity{


	@Override
	protected void initActivity(){
		super.initActivity();
		this.setRootView(R.layout.demo_entry_activity, 0);
	...
	private FilterManagerDelegate mFilterManagerDelegate = new FilterManagerDelegate(){
		...
		public void onFilterManagerInited(FilterManager manager){
			TuSdk.messageHub().showSuccess(SecondEntryActivity.this, R.string.lsq_inited);
		}
	};
